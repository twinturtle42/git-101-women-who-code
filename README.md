...
| 3 | List of terminal Commands for [Windows](https://www.thomas-krenn.com/en/wiki/Cmd_commands_under_Windows)<br/>List of terminal Commands for [Linux/Mac Users](https://fossbytes.com/a-z-list-linux-command-line-reference/)<br/>Le Wagon Cheatsheet for [Mac & Linux Users](http://bit.ly/gitgithubcheatsheetmac).<br/> Le Wagon Cheatsheet for [Windows Users](http://bit.ly/gitgithubcheatsheetmac)<br/>List of [Git Commands](https://github.com/joshnh/Git-Commands)
